...
* <math> <mrow> <mstyle mathvariant="bold" mathsize="normal"><mi>p</mi></mstyle><mo>=</mo><mfrac> <mi>h</mi> <mi>λ</mi> </mfrac> </mrow></math>, can be used to explain observations of comets and may lead to future space technologies.
