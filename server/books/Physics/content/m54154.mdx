...
This video shows how to graph the displacement of a spring in the x-direction over time, based on the period. Watch the first 10 minutes of the video (you can stop when the narrator begins to cover calculus). 
            ...
            [None](#ost/api/ex/k12phys-ch05-ex089)
...
Before solving problems with springs and pendulums, it is important to first get an understanding of how a pendulum works. [None](None) provides a useful illustration of a simple pendulum.


        <caption>A simple pendulum has a small-diameter bob and a string that has a very small mass but is strong enough not to stretch. The linear displacement from equilibrium is s, the length of the arc. Also shown are the forces on the bob, which result in a net force of −</caption>
...
## Solution
1. <math>              <mrow>                <mi>T</mi><mo>=</mo><mn>2</mn><mi>π</mi><msqrt>                  <mrow>                    <mfrac>                      <mi>L</mi>                      <mstyle mathvariant="bold" mathsize="normal"><mi>g</mi></mstyle>                    </mfrac>                  </mrow>                </msqrt>              </mrow>            </math> and solve for *g*<equation id="fs-id1167066870214" class="unnumbered"><label />               <math>                <mrow>                  <mstyle mathvariant="bold" mathsize="normal"><mi>g</mi></mstyle><mo>=</mo><mn>4</mn><msup>                    <mi>π</mi>                    <mn>2</mn>                  </msup>                  <mfrac>                    <mi>L</mi>                    <mrow>                      <msup>                        <mi>T</mi>                        <mn>2</mn>                      </msup>                    </mrow>                  </mfrac>                </mrow>              </math>            </equation>

2. <equation id="fs-id1167066997902" class="unnumbered"><label />               <math>                <mrow>                  <mstyle mathvariant="bold" mathsize="normal"><mi>g</mi></mstyle><mo>=</mo><mn>4</mn><msup>                    <mi>π</mi>                    <mn>2</mn>                  </msup>                  <mfrac>                    <mrow>                      <mn>0.75000</mn><mspace width="0.3em" /><mtext> m</mtext>                    </mrow>                    <mrow>                      <msup>                        <mrow>                          <mo stretchy="false">(</mo><mn>1.7357</mn><mspace width="0.3em" /><mtext> s</mtext><mo stretchy="false">)</mo>                        </mrow>                        <mn>2</mn>                      </msup>                    </mrow>                  </mfrac>                </mrow>              </math>            </equation>

3. *g*<equation id="fs-id1167066827127" class="unnumbered">                <label />                 <math display="block">                  <mrow>                    <mstyle mathvariant="bold" mathsize="normal"><mi>g</mi></mstyle><mo>=</mo><mtext> </mtext><mn>9.8281</mn><mspace width="0.3em" /><mtext> m</mtext><mo>/</mo><msup>                      <mtext>s</mtext>                      <mn>2</mn>                    </msup>                  </mrow>                </math>              </equation>            
...
What is the force constant for the suspension system of a car, like that shown in [None](None), that settles 1.20 cm when an 80.0-kg person gets in?


              <caption>A car in a parking lot. (exfordy, Flickr)</caption>
## Strategy
...
### Practice Problems
            ...
            [None](#ost/api/ex/k12phys-ch05-ex092)
          


            [None](#ost/api/ex/k12phys-ch05-ex093)
...
### Check Your Understanding
          ...
          [None](#ost/api/ex/k12phys-ch05-ex095)
...
### Concept Items
          ...
          [None](#ost/api/ex/k12phys-ch05-ex099)
...
[None](#ost/api/ex/k12phys-ch05-ot078)
...
### Problems
          ...
          [None](#ost/api/ex/k12phys-ch05-ex101)
        


          [None](#ost/api/ex/k12phys-ch05-ex102)
...
[None](#ost/api/ex/k12phys-ch05-ex104)
...
[None](#ost/api/ex/k12phys-ch05-ex107)


[None](#ost/api/ex/k12phys-ch05-ot087)



[None](#ost/api/ex/k12phys-ch05-ot093)
...
[None](#ost/api/ex/k12phys-ch05-ex115)

[None](#ost/api/ex/k12phys-ch05-ex116)
