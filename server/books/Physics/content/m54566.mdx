...
It is the analysis of blackbodies that led to one of the most consequential discoveries of the twentieth century. Take a moment to carefully examine [None](None). What relationships exist? What trends can you see? The more time you spend interpreting this figure, the closer you will be to understanding quantum physics!


<caption>Graphs of blackbody radiation (from an ideal radiator) at three different radiator temperatures. The intensity or rate of radiation emission increases dramatically with temperature, and the peak of the spectrum shifts toward the visible and ultraviolet parts of the spectrum. The shape of the spectrum cannot be described with classical physics.</caption>
...
[None](None) is a plot of radiation intensity against radiated wavelength. In other words, it shows how the intensity of radiated light changes when a blackbody is heated to a particular temperature.
...
A few other important notes regarding [None](None):
...
* *white hot,*
* <math> <mrow>  <mi>v</mi><mo>=</mo><mi>f</mi><mi>λ</mi><mo>.</mo> </mrow></math>  Because the speed of light is constant, frequency and wavelength are inversely related. This is verified by the leftward movement of the three red lines as temperature is increased.
...
[None](#ost/api/ex/k12phys-ch21-ex006)



[None](#ost/api/ex/k12phys-ch21-ex007)
...
[None](#ost/api/ex/k12phys-ch21-ex009)



[None](#ost/api/ex/k12phys-ch21-ex010)



[None](#ost/api/ex/k12phys-ch21-ot006)
...
[None](#ost/api/ex/k12phys-ch21-ex014)
...
[None](#ost/api/ex/k12phys-ch21-ex016)
...
[None](#ost/api/ex/k12phys-ch21-ot007)
...
[None](#ost/api/ex/k12phys-ch21-ex023)
...
[None](#ost/api/ex/k12phys-ch21-ex026)
...
[None](#ost/api/ex/k12phys-ch21-ex029)



[None](#ost/api/ex/k12phys-ch21-ex030)
...
[None](#ost/api/ex/k12phys-ch21-ex032)
...
[None](#ost/api/ex/k12phys-ch21-ex034)
