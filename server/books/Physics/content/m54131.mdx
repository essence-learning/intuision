...
In this case, there are two different systems that we could choose to investigate: the swimmer or the wall. If we choose the swimmer to be the system of interest, as in the figure, then  <math> <mrow>  <msub>   <mtext>F</mtext>   <mrow>    <mtext>wall on feet</mtext>   </mrow>  </msub> </mrow></math>  is an external force on the swimmer and affects her motion. Because   is an external force on the swimmer and affects her motion. Because **acceleration** is in the same direction as the **net external force**, the swimmer moves in the direction of  <math> <mrow>  <msub>   <mtext>F</mtext>   <mrow>    <mtext>wall on feet</mtext>   </mrow>  </msub>  <mo>.</mo> </mrow></math> Because the swimmer is our system (or object of interest) and not the wall, we do not need to consider the force  Because the swimmer is our system (or object of interest) and not the wall, we do not need to consider the force <math> <mrow>  <msub>   <mtext>F</mtext>   <mrow>    <mtext>feet on wall</mtext>   </mrow>  </msub> </mrow></math> because it originates  because it originates *from* the swimmer rather than *acting on* the swimmer. Therefore, <math> <mrow>  <msub>   <mtext>F</mtext>   <mrow>    <mtext>feet on wall</mtext>   </mrow>  </msub> </mrow></math> does not directly affect the motion of the system and does not cancel  does not directly affect the motion of the system and does not cancel <math> <mrow>  <msub>   <mtext>F</mtext>   <mrow>    <mtext>wall on feet</mtext>   </mrow>  </msub>  <mo>.</mo> </mrow></math> Note that the swimmer pushes in the direction opposite to the direction in which she wants to move. Note that the swimmer pushes in the direction opposite to the direction in which she wants to move.
...
<equation id="fs-idm31189056"> <label /> <math> <mrow>  <mstyle mathvariant="bold" mathsize="normal"><mi>N</mi></mstyle><mo>=</mo><mi>m</mi><mstyle mathvariant="bold" mathsize="normal"><mi>g</mi></mstyle><mo>.</mo> </mrow></math></equation>
...
Tension in the rope must equal the weight of the supported mass, as we can prove by using Newton’s second law. If the 5.00 kg mass in the figure is stationary, then its acceleration is zero, so <math> <mrow>  <msub>   <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>   <mrow>    <mtext>net</mtext>   </mrow>  </msub>  <mo>=</mo><mn>0.</mn> </mrow></math> The only external forces acting on the mass are its weight  The only external forces acting on the mass are its weight *W* and the tension *T* supplied by the rope. Summing the external forces to find the net force, we obtain

<equation id="fs-idp4076592"><label /> <math display="block"> <mrow>  <msub>   <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>   <mrow>    <mtext>net</mtext>   </mrow>  </msub>  <mo>=</mo><mstyle mathvariant="bold" mathsize="normal"><mi>T</mi></mstyle><mo>−</mo><mstyle mathvariant="bold" mathsize="normal"><mi>W</mi></mstyle><mo>=</mo><mn>0</mn><mo>,</mo> </mrow></math> </equation>
...
<equation id="fs-idm13005664"><label /> <math display="block"> <mrow>  <mstyle mathvariant="bold" mathsize="normal"><mi>T</mi></mstyle><mo>=</mo><mstyle mathvariant="bold" mathsize="normal"><mi>W</mi></mstyle><mo>=</mo><mi>m</mi><mstyle mathvariant="bold" mathsize="normal"><mi>g.</mi></mstyle> </mrow></math> </equation>
For a 5.00-kg mass (neglecting the mass of the rope), we see that 

<equation id="fs-idm4932496"><label /> <math display="block"> <mrow>  <mstyle mathvariant="bold" mathsize="normal"><mi>T</mi></mstyle><mo>=</mo><mi>m</mi><mstyle mathvariant="bold" mathsize="normal"><mi>g</mi></mstyle><mo>=</mo><mo stretchy="false">(</mo><mn>5.00</mn><mspace width="0.3em" /><mtext> kg)(9</mtext><msup>   <mrow>    <mtext>.80 m/s</mtext>   </mrow>   <mn>2</mn>  </msup>  <mo stretchy="false">)</mo><mo>=</mo><mn>49.0</mn><mspace width="0.3em" /><mtext> N</mtext><mtext>.</mtext> </mrow></math> </equation>
...
## Strategy
Because they accelerate together, we define the system to be the teacher, the cart, and the equipment. The teacher pushes backward with a force <math> <mrow>  <msub>   <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>   <mrow>    <mtext>foot</mtext>   </mrow>  </msub> </mrow></math> of 150 N. According to Newton’s third law, the floor exerts a forward force   of 150 N. According to Newton’s third law, the floor exerts a forward force  <math> <mrow>  <msub>   <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>   <mrow>    <mtext>floor</mtext>   </mrow>  </msub> </mrow></math> of 150 N on the system. Because all motion is horizontal, we can assume that no net force acts in the vertical direction, and the problem becomes one dimensional. As noted in the figure, the friction f opposes the motion and therefore acts opposite the direction of   of 150 N on the system. Because all motion is horizontal, we can assume that no net force acts in the vertical direction, and the problem becomes one dimensional. As noted in the figure, the friction f opposes the motion and therefore acts opposite the direction of  <math> <mrow>  <msub>   <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>   <mrow>    <mtext>floor</mtext>   </mrow>  </msub>  <mo>.</mo> </mrow></math>  

We should not include the forces  <math> <mrow>  <msub>   <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>   <mrow>    <mtext>teacher</mtext>   </mrow>  </msub> </mrow></math>,  ,  <math> <mrow>  <msub>   <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>   <mrow>    <mtext>cart</mtext>   </mrow>  </msub> </mrow></math>, or  , or  <math> <mrow>  <msub>   <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>   <mrow>    <mtext>foot</mtext>   </mrow>  </msub> </mrow></math> because these are exerted  because these are exerted *by* the system, not *on* the system. We find the net external force by adding together the external forces acting on the system (see the free-body diagram in the figure) and then use Newton’s second law to find the acceleration.

## Solution
Newton’s second law is

<equation id="fs-idm40957840"><label /> <math> <mrow>  <mstyle mathvariant="bold" mathsize="normal"><mi>a</mi></mstyle><mi> </mi><mo>=</mo><mi> </mi><mfrac>   <mrow>    <msub>     <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>     <mrow>      <mtext>net</mtext>     </mrow>    </msub>   </mrow>   <mi>m</mi>  </mfrac><mtext>.</mtext> </mrow></math> </equation>
...
<equation id="fs-idm17057056"><label /> <math> <mrow>  <msub>   <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>   <mrow>    <mtext>net</mtext>   </mrow>  </msub>  <mi> </mi><mo>=</mo><mi> </mi><msub>   <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>   <mrow>    <mtext>floor</mtext>   </mrow>  </msub>  <mo>−</mo><mstyle mathvariant="bold" mathsize="normal"><mi>f</mi></mstyle><mtext> </mtext><mo>=</mo><mtext>150 N</mtext><mo>−</mo><mtext>24</mtext><mtext>.0 N</mtext><mo>=</mo><mtext>126 N.</mtext> </mrow></math> </equation>
The mass of the system is the sum of the mass of the teacher, cart, and equipment.

<equation id="fs-idm17969744"><label /> <math display="block">   <mrow>   <mi>m</mi><mtext> = (65</mtext><mtext>.0 + 12</mtext><mtext>.0 + 7</mtext><mtext>.0) kg = 84 kg</mtext>  </mrow> </math> </equation>
Insert these values of net F and *m* into Newton’s second law to obtain the acceleration of the system.

<equation id="fs-idp14220304"><label /> <math display="block">   <mrow>   <mtable columnalign="left">    <mtr columnalign="left">     <mtd columnalign="left">      <mrow>       <mstyle mathvariant="bold" mathsize="normal"><mi>a</mi></mstyle><mo>=</mo><mfrac>        <mrow>         <msub>          <mstyle mathvariant="bold" mathsize="normal"><mi>F</mi></mstyle>          <mrow>           <mtext>net</mtext>          </mrow>         </msub>        </mrow>        <mi>m</mi>       </mfrac>      </mrow>     </mtd>    </mtr>    <mtr columnalign="left">     <mtd columnalign="left">      <mrow>       <mi>a</mi><mo>=</mo><mfrac>        <mrow>         <mtext>126 N</mtext>        </mrow>        <mrow>         <mtext>84 kg</mtext>        </mrow>       </mfrac>       <mo>=</mo><mtext>1</mtext><msup>        <mrow>         <mtext>.5 m/s</mtext>        </mrow>        <mn>2</mn>       </msup>      </mrow>     </mtd>    </mtr>   </mtable>  </mrow> </math></equation>
<equation id="fs-id1164564959355"> <math display="block">   <mrow>   <msub>    <mi>F</mi>    <mn>1</mn>   </msub>   <mo>&lt;</mo><msub>    <mi>F</mi>    <mn>2</mn>   </msub>  </mrow> </math></equation>
## Discussion
...
<table>  <tr>    <td>normal force for a nonaccelerating horizontal surface</td>    <td><math>       <mrow>        <mstyle mathvariant="bold" mathsize="normal"><mi>N</mi></mstyle><mo>=</mo><mi>m</mi><mstyle mathvariant="bold" mathsize="normal"><mi>g</mi></mstyle>       </mrow>      </math></td>  </tr>  <tr>    <td>tension for an object at rest</td>    <td><math>       <mrow>        <mstyle mathvariant="bold" mathsize="normal"><mi>T</mi></mstyle><mo>=</mo><mi>m</mi><mstyle mathvariant="bold" mathsize="normal"><mi>g</mi></mstyle>       </mrow>      </math></td>  </tr></table>
...
1. <math>   <mrow>   <mfrac>    <mtext>F</mtext>    <mrow>     <mn>30</mn>    </mrow>   </mfrac>  </mrow> </math>
2. F
3. 2F
4. 30F
