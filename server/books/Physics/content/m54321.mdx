...
From this relationship, we see that in a medium where *v*w is constant, the higher the frequency, the smaller the wavelength. See [None](None).
...
1. <math>   <mrow>   <msub>    <mi>v</mi>    <mtext>w</mtext>   </msub>   <mo>=</mo><mi>f</mi><mi>λ</mi><mo>.</mo>  </mrow> </math> 
2. <math>   <mrow>   <msub>    <mi>v</mi>    <mtext>w</mtext>   </msub>   <mo>=</mo><mfrac>    <mi>f</mi>    <mi>λ</mi>   </mfrac>   <mo>.</mo>  </mrow> </math> 
3. <math>   <mrow>   <msub>    <mi>v</mi>    <mtext>w</mtext>   </msub>   <mo>=</mo><mfrac>    <mi>λ</mi>    <mi>f</mi>   </mfrac>   <mo>.</mo>  </mrow> </math> 
4. <math>   <mrow>   <msub>    <mi>v</mi>    <mtext>w</mtext>   </msub>   <mo>=</mo><msqrt>    <mrow>     <mi>f</mi><mi>λ</mi>    </mrow>   </msqrt>   <mo>.</mo>  </mrow> </math> 
...
* *v*w
* <math> <mi>λ</mi></math>, which is the distance between adjacent identical parts of the wave.
* <math> <mrow>  <msub>   <mi>v</mi>   <mtext>w</mtext>  </msub>  <mo>=</mo><mfrac>   <mi>λ</mi>   <mi>T</mi>  </mfrac> </mrow></math>  or  <math> <mrow>  <msub>   <mi>v</mi>   <mtext>w</mtext>  </msub>  <mo>=</mo><mi>f</mi><mi>λ</mi><mtext>.</mtext> </mrow></math> 
* *T*
