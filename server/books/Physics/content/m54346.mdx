...
What happens if the radius of the sphere is increased 2 m? The illuminance is now only one-fourth as great, because the *r*<sup>2</sup> term in the denominator is 4 instead of 1. [None](None) shows how illuminance decreases with the inverse square of the distance.


<caption>The diagram shows why the illuminance varies inversely with the square of the distance from a source of light.</caption>
...
[None](#ost/api/ex/k12phys-ch15-ex027)
...
[None](#ost/api/ex/k12phys-ch15-ot024)
...
1. <sup>6</sup><sup>6</sup>
2. 3.75 Hz to 7.50 Hz
3. <sup>−7</sup><sup>−7</sup>
4. <sup>14</sup><sup>14</sup>
...
1. <math>   <mrow>   <mtext>Illuminance = </mtext><mfrac>    <mi>P</mi>    <mrow>     <mtext> 4</mtext><mi>π</mi><msup>      <mi>r</mi>      <mtext>2</mtext>     </msup>    </mrow>   </mfrac>   <mtext>;</mtext>  </mrow> </math>  if distance is tripled, then the illuminance increases by 19 times.
2. <math>   <mrow>   <mtext>Illuminance = </mtext><mfrac>    <mi>P</mi>    <mrow>     <mtext> 4</mtext><mi>π</mi>      <mi>r</mi>    </mrow>   </mfrac>   <mtext>;</mtext>  </mrow> </math>  if distance is tripled, then the illuminance decreases by 13 times.
3. <math>   <mrow>   <mtext>Illuminance = </mtext><mi>P</mi><mi> </mi><mtext>· 4</mtext><mi>π</mi><msup>    <mi>r</mi>    <mtext>2</mtext>   </msup>   <mtext>;</mtext>  </mrow>   </math>  if distance is tripled, then the illuminance decreases by 9 times.
4. <math>   <mrow>   <mtext>Illuminance = </mtext><mi>P</mi><mi> </mi><mtext>· 4</mtext><mi>π</mi>    <mi>r</mi>       <mtext>;</mtext>  </mrow>   </math>  if distance tripled, then the illuminance increases by 3 times.
...
[None](#ost/api/ex/k12phys-ch15-ex037)
...
[None](#ost/api/ex/k12phys-ch15-ex041)
