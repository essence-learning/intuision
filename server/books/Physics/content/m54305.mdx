...
A very different process in this second worked example produces the same 9.00 J change in internal energy as in the first worked example. Note that the change in the system in both parts is related to  <math> <mrow>  <mi>Δ</mi><mi>U</mi></mrow></math>  and not to the individual   and not to the individual *Q*’s or *W*’s involved. The system ends up in the *same *state in both problems. Note that, as usual, in [None](None) above,  <math> <mrow>  <msub>   <mi>W</mi>   <mrow>    <mtext>out</mtext></mrow>  </msub>  </mrow></math> is work done 
...
* <math> <mrow>  <mi>Δ</mi><mi>U</mi><mo>=</mo><mi>Q</mi><mo>−</mo><mi>W</mi></mrow></math>, where  <math> <mrow>  <mi>Δ</mi><mi>U</mi></mrow></math>  is the change in internal energy of a system, *Q **W *
* *Q **W *<math> <mrow>  <mi>Δ</mi><mi>U</mi></mrow></math>  represents an independent quantity of energy capable of being stored.
* *U *
...
1. <math>   <mrow>   <mrow><mo>(</mo>    <mrow>       <mi>P</mi><mspace width="0.25em" /><mo>∝</mo><mtext> </mtext><mfrac>      <mtext>1</mtext>      <mi>T</mi>     </mfrac>    </mrow>   <mo>)</mo></mrow>  </mrow> </math>
2. <math>   <mrow>   <mrow><mo>(</mo>    <mrow>     <mi>P</mi><mspace width="0.25em" /><mo>∝</mo><mtext> </mtext><msqrt>      <mi>T</mi>     </msqrt>    </mrow>   <mo>)</mo></mrow>  </mrow> </math> 
3. <math>   <mrow>   <mrow><mo>(</mo>    <mrow><mi>P</mi><mspace width="0.25em" /><mo>∝</mo><mtext> </mtext>      <mi>T</mi>         </mrow>   <mo>)</mo></mrow>  </mrow> </math> 
4. <math>   <mrow>   <mrow><mo>(</mo>    <mrow><mi>P</mi><mspace width="0.25em" /><mo>∝</mo><msup>      <mrow><mspace width="0.25em" /><mi>T</mi>      </mrow>      <mtext>2</mtext>     </msup>    </mrow>   <mo>)</mo></mrow>  </mrow> </math> 
